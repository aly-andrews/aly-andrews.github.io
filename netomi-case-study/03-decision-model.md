...
title: Netomi case study decision model
...
<div class="work-section-header">
  <div class="work-image-large">
    <div class="image-placeholder">
      <p>Framework visual placeholder</p>
      <p class="placeholder-hint">Add a simple flow diagram: intake → triage → draft → review → publish</p>
    </div>
  </div>
  <div class="work-section-intro">
    <p>My model balances speed and control:</p>
  </div>
</div>

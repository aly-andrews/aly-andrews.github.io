...
title: Netomi case study intro
permalink: /netomi-case-study/01-intro/
...
<div class="work-section-header">
  <div class="work-image-large">
    <div class="image-placeholder">
      ...
      <p class="placeholder-hint">Add a thumbnail or hero image for the presentation opener</p>
    </div>
  </div>
  <div class="work-section-intro">
    <p><strong>Netomi weekly release schedule</strong></p>
    <p>This presentation outlines a practical documentation workflow for weekly releases under changing scope and incomplete inputs.</p>
  </div>
</div>
